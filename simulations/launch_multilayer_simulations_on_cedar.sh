...
for adoption_within_private_profiles in \${adoption_within_private_profiles_values[*]}; do
  bin/multilayer ../Facebook100/NAME1.txt OBSERVATION_DEPTH_L APP_COVERAGE FRACTION_OF_PRIVATE_PROFILES \$adoption_within_private_profiles ADOPTION_OF_PASSPORTS NB_SIMULATIONS NAME1 >> \$HOME/scratch/\$SLURM_JOB_ID.txt
done
